...
新規登録フォームにてユーザー登録を行っていただくと、
楽曲の投稿、お気に入り登録、フレンド機能が利用できます。  
...
* モダンな開発技術に触れたかったため、Docker,Circleciといったインフラ技術を学習し導入しました。
...
### ①インフラ技術
インフラの学習としてモダンな開発環境に触れたかったため、
Docker、Circleci、AWS、Capistranoを用いてCI/CDパイプラインを構築しました。

### ②使用感
作曲を行っている知人に実際に触ってもらい意見を取り入れ、不便な箇所を改善していきました。
また、仕様上の疑問点などを挙げてもらうことで、データベース設計の見直しをする機会もありました。
